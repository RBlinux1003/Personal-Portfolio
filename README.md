...
1. In the file `.github/workflows/linters.yml` [line 48](https://raw.githubusercontent.com/TheDevMBA/linters-config/blob/main/html-css/.github/workflows/linters.yml#L48) replace `"**/*.{css,scss}"` with `"**/*.scss"`
